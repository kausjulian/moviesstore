        ...
        <>
            <nav className=" row navbar navbar-expand-lg navbar-light header shadow-lg">
                <div className="container-fluid">
                    ...
                    {/* <Link className="navbar-brand text-center headertitle" to="/">Movies Store</Link> */}
                    ...
                    <div className="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                        ...
                        <Link className="nav-link" to="/Favs">Favorites</Link>
                            ...
                            <Link  to="/Favs"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart ms-2 icon" viewBox="0 0 16 16">
                 ...
                 <div className={click === false ? 'icons': 'd-none'}>
                            <Link  to="/Profile"> <svg xmlns="http://www.w3.org/2000/svg"  width="16" height="16" fill="currentColor" className="bi bi-person-circle icon" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                            </svg></Link>
                            <Link  to="/Favs"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart ms-2 icon" viewBox="0 0 16 16">
